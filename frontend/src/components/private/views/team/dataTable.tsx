		...
		() => [
			{
				...
				id: 'name',
				header: () => (
					<div className="text-center font-medium">Nome</div>
				),
				cell: ({ row }) => (
			...
			},
			{
				accessorKey: 'email',
				header: () => (
					<div className="text-center font-medium">E-mail</div>
				),
				cell: ({ row }) => (
			...
			},
			{
				...
				id: 'role',
				header: () => (
					<div className="text-center font-medium">Função</div>
				),
				cell: ({ row }) => (
			...
			},
			{
				...
				id: 'store',
				header: () => (
					<div className="text-center font-medium">Loja</div>
				),
				cell: ({ row }) => (
