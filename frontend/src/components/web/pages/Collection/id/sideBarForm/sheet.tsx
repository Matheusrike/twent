    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
          "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-2/5 ",
      ...
      >
        ...
        <div className="w-full flex items-center justify-between px-5 py-6">
          ...
          <h1 className="text-center flex-1">Contactar uma boutique</h1>
