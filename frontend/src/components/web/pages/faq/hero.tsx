...
const FaqHero = () => {
  return (
    <div className="relative z-10 w-full px-6 lg:px-20 container p-5">
    <div className="mx-auto w-full ">
      {/* Header */}
      <div className="my-10 text-center lg:text-left">
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-primary dark:text-white mb-8 tracking-tight leading-tight">
          Perguntas <br /> Frequentes
        </h2>
        <p className="text-gray-500 dark:text-white text-lg md:text-xl leading-relaxed font-light max-w-3xl">
      ...
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
        {faqData.map(({ question, answer, icon }) => {
          ...
          return (
            <div
              key={question}
              className="group relative overflow-hidden border border-gray-200/50 dark:border-white/5 rounded-2xl p-10 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1 bg-white dark:bg-background"
            >
              {/* Hover gradient */}
              <div 
