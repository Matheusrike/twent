  ...
  return (
    <div className="min-h-screen w-full container">
      <div className="w-full  mx-auto py-12 px-6">
        <h2 className="text-3xl leading-10 sm:text-4xl md:text-[40px] md:leading-13 font-semibold tracking-tight dark:text-white">
        ...
        <div className="mt-8 grid sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-muted rounded-xl p-6 col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <Button variant="standartButton" size="standartButton">
